...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    <div class="card-header">
      <form id="filterFormAbsensi" class="mb-4">
        @csrf
        <input type="hidden" name="filter_type" value="absensi">
        <div class="row g-3 align-items-center">
          <div class="col-md-6">
            <div class="input-group">
              <label class="input-group-text" for="filter_date_absensi">Tanggal Absensi</label>
              <input type="date" class="form-control" id="filter_date_absensi" name="filter_date_absensi">
            </div>
          </div>
          <div class="col-md-6">
            <button type="button" class="btn btn-primary" onclick="filterData('absensi')">Filter</button>
          </div>
        </div>
      </form>
    </div>
    <div class="card-body">
      <table class="table table-responsive table-hover datatable" id="absensiTable">
        <thead>
          <tr>
